...
import com.umc.android.packit.databinding.ActivityMapBinding
import com.umc.android.packit.databinding.FragmentStoreListBinding

class MapActivity : AppCompatActivity(), OnMapReadyCallback, StoreListRVAdapter.MyItemClickListener {
